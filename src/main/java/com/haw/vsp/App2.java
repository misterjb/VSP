...
public class App2 {
	...
	private static void testalles3() throws UnirestException {
		 ...
		 * "-----------------------------------------------------------------------------------\n";
		 * 
		 * signInTaverna("mailbox","group, election, bully, mutex"
		 * ,"/users/jannikb","172.19.0.50:4567");
		 */
		...
		postAssignments("3", "/wounded", "/stretcher/handle/back", tokenMap.get("Token:Bloody Handle back").toString(),
				"do the back", "yes", grouplist.get(0));
	}
